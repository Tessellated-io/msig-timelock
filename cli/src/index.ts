...
import { bytesToSubmit, deployMultisig, submit, keyRotationbytesToSubmit, rotateKey, cancel, cancelbytesToSubmit, executeCommand } from './commands'
...
program
  ...
  .action(function (commandObject) {
    ...
    bytesToSubmit(operation, commandObject.nodeUrl, commandObject.nonce, commandObject.multisigAddress, commandObject.auto)
  })
...
program
  ...
  .action(function (commandObject) {
    ...
    keyRotationbytesToSubmit(commandObject.threshold, keys, commandObject.nodeUrl, commandObject.nonce, commandObject.multisigAddress, commandObject.auto)
  })
...
program
  ...
  .action(function (commandObject) {
    ...
    cancelbytesToSubmit(commandObject.operationId, commandObject.nodeUrl, commandObject.nonce, commandObject.multisigAddress, commandObject.auto)
  })
...
program
  ...
  .action(function (commandObject) {
    ...
    cancel(commandObject.operationId, addresses, signatures, commandObject.nonce, commandObject.multisigAddress, commandObject.nodeUrl, commandObject.privateKey, commandObject.auto)
  })
...
program
  ...
  .action(function (commandObject) {
    ...
    rotateKey(commandObject.threshold, keys, addresses, signatures, commandObject.nonce, commandObject.multisigAddress, commandObject.nodeUrl, commandObject.privateKey, commandObject.auto)
  })
...
program
  ...
  .action(function (commandObject) {
    ...
    submit(operation, addresses, signatures, commandObject.nonce, commandObject.multisigAddress, commandObject.nodeUrl, commandObject.privateKey, commandObject.auto)
  })
